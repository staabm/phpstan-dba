...
class Foo
{
    public function foo(Connection $conn)
    {
        ...
        assertType('Doctrine\DBAL\Driver\Result<array{email: string, 0: string, adaid: int<0, 4294967295>, 1: int<0, 4294967295>, gesperrt: int<-128, 127>, 2: int<-128, 127>, freigabe1u1: int<-128, 127>, 3: int<-128, 127>}>', $result);
