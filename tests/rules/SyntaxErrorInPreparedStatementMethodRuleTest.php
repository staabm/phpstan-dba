...
LINE 1: EXPLAIN UPDATE package SET indexedAt=\'1970-01-01\' WHERE id I...
                       ^ (42P01).',
                    180,
                ],
                [
...
LINE 1: EXPLAIN INSERT IGNORE INTO `s_articles_supplier` (`id`, `nam...
    ...
    public function testBug603()
    {
        ...
        if (MysqliQueryReflector::NAME === getenv('DBA_REFLECTOR')) {
            $expectedErrors = [
                [
                    "Query error: Table 'phpstan_dba.invalid_table' doesn't exist (1146).",
                    10,
                ],
            ];
        } elseif (PdoPgSqlQueryReflector::NAME === getenv('DBA_REFLECTOR')) {
...
LINE 1: SELECT * FROM invalid_table WHERE id = \'123\' LIMIT 0
            ...
            $expectedErrors = [
                [
                    "Query error: SQLSTATE[42S02]: Base table or view not found: 1146 Table 'phpstan_dba.invalid_table' doesn't exist (42S02).",
                    10,
                ],
            ];
        } else {
